...
class Tools {
     ...
     * @return mixed
     */
    public static function _csvEnCoding($arr) {
     ...
     * @return [type]       [string]
     */
    public static function dayToWeek($day, $type) {
        if ($type == 1) {
     ...
     * @param  [type] $sortkey [键值]
     * @param  string $start   [description]
     * @param  string $len     [description]
     * @return [type]          [description]
     */
    public static function arrayMultirSort($data, $sortkey, $start = '', $len = '') {
     ...
     * @return [type]          [description]
     */
    public static function arrayMultiSort($data, $sortkey, $start = '', $len = '') {
        foreach ($data as $key => &$value) {
            foreach ($data as $k => $val) {
                if ($value[$sortkey] < $val[$sortkey]) {
                    $tmp        = $val;
